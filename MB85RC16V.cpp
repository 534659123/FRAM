...
*/
/**************************************************************************/
void MB85RC16V::write8 (uint16_t framAddr, uint8_t value)
{
...
//continuous 
void MB85RC16V::write8 (uint16_t framAddr,uint8_t length, uint8_t data[])
{
...
//continuous 
void MB85RC16V::write8 (uint16_t framAddr,uint8_t length, char data[])
{
  uint16_t addr = framAddr;
  for(int i=0;i<length;i++)
  {
...
*/
/**************************************************************************/
uint8_t MB85RC16V::read8 (uint16_t framAddr)
{
  Wire.beginTransmission(_i2c_addr);
  Wire.write(framAddr&0b11111111111);
  Wire.endTransmission();
...
//continuous 
void MB85RC16V::read8 (uint16_t framAddr,uint8_t num,uint8_t data[])
{
  Wire.beginTransmission(_i2c_addr);
  Wire.write(framAddr&0b11111111111);
  Wire.endTransmission();
...
//continuous 
void MB85RC16V::read8 (uint16_t framAddr,uint8_t num,char data[])
{
  Wire.beginTransmission(_i2c_addr);
  Wire.write(framAddr&0b11111111111);
  Wire.endTransmission();
